...
converts language-specific verbal information, e.g. _"circa 1st half of the
19th century"_, into its standardized numerical counterparts, e.g.
_"1801-01-01~/1850-12-31~"_. It follows the recommendations of the MIDAS
...
[_Struwwelpeter_](https://www.gutenberg.org/files/12116/12116-h/12116-h.htm).
...
Many real-world entries list several _distinct_ datings rather than one period,
...
For the real _Deckenmalerei_ entries below, `verbal_dating_resolved.csv` then
contains:
